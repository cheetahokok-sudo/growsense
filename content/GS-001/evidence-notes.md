# GS-001 · Evidence Notes

Every load-bearing claim in the article maps to a **verified** reference here.
If a claim can't be tied to a verified source, it must be softened to plain
educational framing or cut. This is the internal audit trail — reviewers
(and future us) check the article against this table.

| # | Claim in the article | Support | Verified? |
|---|---|---|---|
| 1 | ~70% of sleep-related GH pulses coincide with slow-wave (N3) sleep | Van Cauter & Plat 1996 | ✅ |
| 2 | Height is highly polygenic; hundreds of variants across ≥180 loci | Lango Allen et al. 2010 | ✅ |
| 3 | 60–80% of height variation is heritable in affluent populations | Silventoinen et al. 2003 | ✅ |
| 4 | Oestrogen drives the pubertal growth spurt and eventual growth-plate fusion (both sexes) | Juul 2001 | ✅ |
| 5 | Diet and physical activity modulate growth/pubertal development | Rogol, Clark & Roemmich 2000 | ✅ |
...
- Never claim any habit *increases height*. Habits support the child reaching
  their **own genetic potential**; the arc bends over years, not weeks.
- Percentiles are illustrative WHO references, not a verdict.
- Exercise builds **bone strength/density**, it does not stretch bones taller.
- Every "consult your doctor" trigger stays framed as reassurance-seeking,
  not alarm.
